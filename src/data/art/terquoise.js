...
export const turquoiseArt = [
    { id: 1, name: 'Alexandre Dupont', nameRu: 'Александр Дюпон', image: src1, category: 'turquoise', comer: true },
    { id: 2, name: 'Sophie Martin', nameRu: 'София Мартин', image: src2, category: 'turquoise', doc: true },
    ...
    { id: 16, name: 'Pauline Gauthier', nameRu: 'Полина Готье', image: src16, category: 'turquoise', doc: true },
