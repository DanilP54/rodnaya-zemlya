...
export function TurquoiseFiltersLiterature() {
            ...
            <div style={{ width: '100%' }}>
                ...
                </div>
                {
                    checkedGenre && <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '10px' }}>
                        <Demo title={'Post-apocalyptic'} color={primaryColor} />
                        <Demo title={'Horror'} color={primaryColor} />
                        <Demo title={'Mystery'} color={primaryColor} />
                        <Demo title={'Gothic'} color={primaryColor} />
                        <Demo title={'Philosophical'} color={primaryColor} />
                    </div>
                }
