...
export function RedFiltersLiterature({ setValue }) {
            ...
            <div style={{ width: '100%' }}>
                ...
                </div>
                {
                    checkedGenre && <Chip.Group onChange={setValue} multiple><Group gap={'10px'} mt={'10px'} align="center">
                        <CustomChip title={'Post Apocalyptic'} color={primaryColor} checkedGenre={checkedGenre} />
                        <CustomChip title={'Horror'} color={primaryColor} checkedGenre={checkedGenre} />
                        <CustomChip title={'Classic'} color={primaryColor} checkedGenre={checkedGenre} />
                        <CustomChip title={'Gothic'} color={primaryColor} checkedGenre={checkedGenre} />
                        <CustomChip title={'Philosophical'} color={primaryColor} checkedGenre={checkedGenre} />
                    </Group></Chip.Group>
                }
