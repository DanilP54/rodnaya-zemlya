            ...
            <div style={{ width: '100%' }}>
                ...
                </div>
                {
                    checkedGenre && <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '10px' }}>
                        <Demo title={'Crime'} color={'#00CED1'} />
                        <Demo title={'Drama'} color={'#00CED1'} />
                        <Demo title={'Thriller'} color={'#00CED1'} />
                        <Demo title={'Sci-Fi'} color={'#00CED1'} />
                        <Demo title={'Action'} color={'#00CED1'} />
                    </div>
                }
