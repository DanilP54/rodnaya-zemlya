...
function AddFavoriteIcon({ like, color = "currentColor" }) {
  if (like) {
    return (
      <svg
...
export function MovieSection() {
  ...
  const handleSave = () => {
    if (true) {
      return toast(
        "Зарегестрируйтесь, пожалуйста, что бы добавить фильм в коллекцию",
        {
          transition: Slide,
          position: "top-right",
          theme: "dark",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Список Волока / Volok's List
          </span>
        </div>
        <Tooltip position="right-start" offset={10}  label="Посмотрю попозже">
          <div
            onClick={handleSave}
            style={{
              position: "relative",
        ...
        >
          ...
          >
            ...
            <span
              ...
              className="descr"
            >
              Никита Волок куда-то пошёл, и что-то сделал, после чего, Волок,
              конечно, уже не был прежним
            </span>
          </div>
        </div>
